...
<main class="main-content">
	...
	<div class="container mt-5 mb-5">
		...
		<div class="mb-4">
			<h5 class="fw-bold">상품 이미지</h5>
			<!--  <img src="http://localhost/adminSystem/uploads/d12cfa03-e530-49b2-a302-9c7f790d28f4_원형 테이블2.jpg"/> -->

			<div class="d-flex gap-3 flex-wrap">
				<c:forEach var="image" items="${product.images}">
					<c:if test="${image.imageType eq 'THUMBNAIL'}">
						<div>
							<img src="http://localhost${image.fileUrl}"
								alt="${product.pname}"
		...
		<div class="card shadow-sm border-0">
			...
			<div class="card-footer bg-white border-top p-3">
				<div class="d-flex justify-content-between">
					<a
						href="${pageContext.request.contextPath}/product/list?${requestDTO.pageLink}"
						class="btn btn-outline-secondary">목록</a> <a
						href="${pageContext.request.contextPath}/product/modify/${product.pno}?${requestDTO.pageLink}"
						class="btn btn-primary">상품 수정</a>
				</div>
			</div>
		</div>
	</div>
